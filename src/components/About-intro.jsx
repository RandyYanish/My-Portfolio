                    ...
                    <div className='mb-0 pb-0'>
                        <div className='flex flex-col md:flex-row items-center'>
                            <p className='text-ice-dark dark:text-metal font-sans text-lg sm:text-2xl p-1 py-4 md:w-2/3'>
                                <span className='text-steel-dark dark:text-metal-light font-serif  text-xl sm:text-3xl'>Hey, all!</span> I am skilled Full-Stack Engineer with a strong foundation in both front-end and back-end development. I hold a Full-Stack Software Engineering Certificate from the University of Minnesota, demonstrating my commitment to continuous learning and growth in the field.
                            </p>
                            <div className='p-1'>
